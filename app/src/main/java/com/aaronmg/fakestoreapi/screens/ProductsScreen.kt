...
fun ProductScreen(
    ...
    // SOLO SE EJECUTA AL INICAR LA APP
    LaunchedEffect(key1 = true) {
        try {
            // CREAR UNA INSTANCIA DE RETROFIT!!! --> LIBRERÍA PARA HACER PETICIONES HTTP
            // Patrón de Diseño Builder -- Singleton, Builder, Repository, DI, MVVM
            ...
            val result = async(Dispatchers.IO) {
                // TENDRÍAMOS QUE HACER MUCHO CÓDIGO
